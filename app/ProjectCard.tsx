...
function ProjectCard({project}:Props) {
  return (
    <div
     className='flex text-violet-50 p-5 shadow-lg flex-col bg-[#222831] items-center justify-center drop-shadow-xl'>
    <div className='flex flex-row space-x-10 justify-between'>
      <h1 className='text-center underline underline-offset-8 decoration-sky-400 pb-2 font-bold md:text-2xl lg:pb-4 md:tracking-[10px]'>{project.title}</h1>
      <a href={project.linkToBuild} className='flex bg-violet-50 space-x-2 sm:h-7 cursor-pointer rounded-full h-5 px-4'>
